...
public class RoundedButtonV2 extends JButton {
	...
	public RoundedButtonV2() {
		super();
		decorate();
	}

	public RoundedButtonV2(String text) {
		super(text);
		decorate();
	}

	public RoundedButtonV2(Action action) {
		super(action);
		decorate();
	}

	public RoundedButtonV2(Icon icon) {
		super(icon);
		decorate();
	}

	public RoundedButtonV2(String text, Icon icon) {
		super(text, icon);
		decorate();
	}
